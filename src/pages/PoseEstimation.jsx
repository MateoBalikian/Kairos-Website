        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="mb-16 max-w-2xl">
            ...
            <p className="text-white/50 leading-relaxed" style={{ fontSize: '1rem' }}>
              Pose Estimation aplicada ao seu movimento. Envie seu vídeo e receba um laudo biomecânico completo — ângulos articulares, assimetrias, oscilação e alinhamento, com recomendações práticas.
            </p>
          </div>
            ...
            <div className="rounded-3xl p-6 lg:p-8 flex flex-col justify-between gap-8"
              ...
              <div>
                <div className="flex items-start justify-between mb-6">
                  <div>
                    <span className="font-sans text-xs uppercase tracking-widest px-3 py-1.5 rounded-full"
                      style={{ background: 'rgba(75,123,245,0.15)', color: '#4B7BF5', border: '1px solid rgba(75,123,245,0.3)' }}>
                      Análise Única
                    </span>
                  </div>
                  <div className="text-right">
                    <p className="font-sans font-bold text-white" style={{ fontSize: '1.8rem', lineHeight: 1 }}>R$70</p>
                    <p className="text-white/30 text-xs mt-1">por vídeo</p>
                  </div>
                </div>
                ...
                <p className="text-white/50 text-sm leading-relaxed mb-6">
                  Envie 1 vídeo do seu movimento — corrida, pedalada ou braçada — e receba um laudo completo com todos os indicadores biomecânicos e recomendações práticas para melhorar.
                </p>
                <div className="flex flex-col gap-3">
                  {[
                    'Laudo com ângulos articulares completos',
                    'Análise de simetria esquerda/direita',
                    'Oscilação vertical e alinhamento axial',
                    'Recomendações práticas de técnica',
                  ].map((item, i) => (
                    <div key={i} className="flex items-center gap-3">
                      <div className="w-4 h-4 rounded-full flex items-center justify-center flex-shrink-0"
                        style={{ background: 'rgba(75,123,245,0.15)' }}>
                        <svg width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="#4B7BF5" strokeWidth="3" strokeLinecap="round">
                          <polyline points="20 6 9 17 4 12" />
                        </svg>
                      </div>
              ...
              <div>
                <div className="mb-6">
                  ...
                  <div className="flex items-end justify-between">
                    <div />
                    <div className="text-right">
                      <p className="font-sans font-bold text-white" style={{ fontSize: '1.8rem', lineHeight: 1 }}>R$170</p>
                      <p className="text-white/50 text-xs mt-1">3 vídeos · 1 mês</p>
                    </div>
                  </div>
                </div>
                <h3 className="font-sans font-bold text-white mb-3" style={{ fontSize: '1.3rem' }}>
                ...
                <p className="text-white/70 text-sm leading-relaxed mb-2">
                  Envie 3 vídeos ao longo de 1 mês e receba o laudo de cada um — mais um relatório comparativo mostrando se você evoluiu, regrediu ou estabilizou entre as análises.
                </p>
                <p className="text-white/40 text-xs mb-6">
                  Equivale a R$56,67 por análise — economia de R$40 vs 3 análises avulsas.
                </p>
                <div className="flex flex-col gap-3">
                  {[
                    '3 laudos biomecânicos completos',
                    'Relatório comparativo de evolução',
                    'Feedback se houve melhora técnica',
                    'Recomendações atualizadas a cada análise',
                  ].map((item, i) => (
                    <div key={i} className="flex items-center gap-3">
                      <div className="w-4 h-4 rounded-full flex items-center justify-center flex-shrink-0"
