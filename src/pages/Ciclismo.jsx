...
const diferenciais = [
  {
    ...
    desc: 'Rastreamos quadril, joelho e tornozelo em tempo real. Assimetrias imperceptíveis ao olho humano ficam visíveis — e corrigíveis.',
    cor: '#4B7BF5',
  },
  {
    tag: 'FISIOLOGIA',
  ...
  },
  {
    ...
    desc: 'Em qual potência sua técnica começa a colapsar? A Veltron identifica o ponto exato onde erro mecânico e aumento de lactato se encontram.',
    cor: '#4B7BF5',
  },
  {
    tag: 'METABOLÔMICA',
          ...
          <div className="rounded-3xl overflow-hidden" style={{ background: '#080808', border: '1px solid rgba(75,123,245,0.2)' }}>
            ...
            <div className="px-6 py-5 flex flex-col lg:flex-row items-start lg:items-center gap-3"
              ...
              <p className="font-sans text-sm text-white/60 leading-relaxed">
                Ângulo do joelho dentro do ideal. Potência anaeróbica acima da média. Limiar de lactato define zonas de treino para as próximas 8 semanas.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                desc: 'Baseado no seu VO₂máx, limiar de lactato e Wingate. Zonas de intensidade individuais, volumes e sessões prescritas para o seu nível e objetivo.',
                cor: '#4B7BF5',
              },
              {
