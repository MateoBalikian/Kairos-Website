...
const steps = [
  ...
  },
  {
    ...
    desc: 'VO₂máx, limiar anaeróbico e potência explosiva medidos com precisão laboratorial em protocolos conduzidos por nossa equipe. Dados que definem zonas de treino e revelam o potencial real de cada atleta.',
  ...
  },
  {
    ...
    techs: ['RMN', 'Metabolômica', '200+ Metabólitos', 'Veltron'],
